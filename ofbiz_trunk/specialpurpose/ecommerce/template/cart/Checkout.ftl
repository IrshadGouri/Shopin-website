...
<div class="container">
    ...
    <div class="table-responsive">
		  ...
		  <tr class="cart-header">
			...
			<div class="sed">
				<h5><a href="single.html">${cartLine.getProductId()}</a></h5>
				<p>(${cartLine.getName()!}) </p>
			...
			<td class="item_price"><@ofbizCurrency amount=cartLine.getDisplayItemSubTotal() isoCode=shoppingCart.getCurrency()/></td>
		  </tr>
	    </#list>
	</table>
	</div>
	...
	<div class="produced">
	<a href="<@ofbizUrl>quickAnonCheckout</@ofbizUrl>" class="hvr-skew-backward">Produced To Checkout</a>
	 </div>
    </div>
</div>
