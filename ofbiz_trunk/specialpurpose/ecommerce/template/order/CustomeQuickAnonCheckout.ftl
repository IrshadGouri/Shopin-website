                        ...
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                              ...
                              <input data-label="First Name" class="form-control validate-name validate-required" id="bill-first-name" name="firstName" value="" type="text">
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                              <label for="bill-last-name">Last Name<span class="asterisk">*</span></label>
                              <input data-label="Last Name" class="form-control validate-lName validate-required" id="bill-last-name" name="lastName" value="" type="text">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="bill-email">Email<span class="asterisk">*</span></label>
                          <input data-label="Email" class="form-control validate-email validate-required" id="bill-email" name="emailAddress" value="" type="email">
                        </div>
                        <div class="form-group">
                          <label for="bill-address1">Address<span class="asterisk">*</span></label>
                          <input data-label="Address" class="form-control validate-nonPoAddress validate-required" address-autocompleter="" addressline1="" id="bill-address1" name="billToAddress1" value="" type="search">
                        </div>
                        <div class="form-group">
                          <input class="form-control validate-nonPoAddress" name="billToAddress2" value="" address2="" type="text">
                        </div>
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                              <label for="bill-country">Country<span class="asterisk">*</span></label>
                              <select data-label="Country" class="form-control validate-required js-country updateShipping calculateTax" country="" id="bill-country" name="billToCountryGeoId" data-update-cart=".shipping-method-section, .order-summary, #cart-overview" data-update-cart-url="AjaxAnonymousCheckout" data-dependent="#bill-state">
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                              ...
                              <select name="billToStateProvinceGeoId" state="" id="bill-state" data-label="State/Province" class="form-control validate-required js-stateProvince updateShipping calculateTax" data-update-cart=".shipping-method-section, .order-summary, #cart-overview" data-update-cart-url="AjaxAnonymousCheckout">
                        ...
                        <div class="row">
                          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <div class="form-group">
                              ...
                              <input data-label="City" class="form-control validate-required" city="" id="bill-city" name="billToCity" value="" type="text">
                            </div>
                          </div>
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group">
                              <label for="bill-zip">Zip<span class="asterisk">*</span></label>
                              <input data-label="Zip" class="form-control validate-usCanadaZip js-postalCode validate-required updateShipping calculateTax zip" postal_code="" id="bill-zip" name="billToPostalCode" data-update-cart=".shipping-method-section, .order-summary, #cart-overview" data-update-cart-url="AjaxAnonymousCheckout" data-country-box="#bill-country" value="" type="text">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="payment-method-section">
                            ...
                            <div id="credit-card-section">
                              ...
                              <div class="form-group">
                                ...
                                <select data-label="Credit Card Type" class="form-control validate-required cardType" id="card-type" name="cardType">
                                    <option value="CCT_VISA">Visa</option>
                                    <option value="CCT_MASTERCARD">Master Card</option>
                              ...
                              <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                  <div class="form-group">
                                    ...
                                    <select data-label="Exp Month" class="form-control validate-expireDate validate-required" id="expire-month" name="expMonth">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                  <div class="form-group">
                                    ...
                                    <select data-label="Exp Year" class="form-control validate-expireDate validate-required" id="expire-year" name="expYear">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td class="product-details-small">Basic Tee<br>
                            ...
                            <small class="hidden-lg pull-right">
                                ...
                                <fieldset class="relative">
                                  <input name="quantity_BASIC-T-PURPLE-L" value="1" size="2" maxlength="4" class="updateCartSm validate-required validate-quantity" data-update-url="updateCheckoutCartItems" data-ajax-update=".order-summary, #cart-overview, .notification-messages" data-param-source=".updateCartSm" data-label="quantity" type="text">
                                  × $15.99 = $15.99&nbsp;&nbsp;
                                </fieldset>
                            </small>
                          </td>
                          ...
                          <td class="visible-lg"><span class="pull-right">$15.99</span></td>
                        </tr>
                        <tr>
                          <td class="text-center visible-lg">
                              <input class="updateCart" name="productId" value="BASIC-T-PURPLE-M" type="hidden">
                              <label class="removeShoppingCartItem btn-link" for="removeItem_BASIC-T-PURPLE-M"><i class="glyphicon glyphicon-remove text-danger"></i></label>
                              <input class="updateCart" id="removeItem_BASIC-T-PURPLE-M" name="removeItem_BASIC-T-PURPLE-M" value="Y" style="display:none" data-update-url="/updateCheckoutCartItems" data-ajax-update=".order-summary, #cart-overview, .notification-messages" data-param-source=".updateCart" type="radio">
                          </td>
                          <td class="product-details-small">Basic Tee<br>
                              <span class="product-features">
                            ...
                            <small class="hidden-lg pull-right">
                                <input class="updateCartSm" name="productId" value="BASIC-T-PURPLE-M" type="hidden">
                                <label class="removeShoppingCartItem btn-link pull-right" for="removeItem_BASIC-T-PURPLE-M"><i class="glyphicon glyphicon-remove fa-lg"></i></label>
                                <input class="updateCartSm" id="removeItem_BASIC-T-PURPLE-M" name="removeItem_BASIC-T-PURPLE-M" value="Y" style="display:none" data-update-url="/updateCheckoutCartItems" data-ajax-update=".order-summary, #cart-overview, .notification-messages" data-param-source=".updateCartSm" type="radio">
                                <fieldset class="relative">
                                  <input name="quantity_BASIC-T-PURPLE-M" value="1" size="2" maxlength="4" class="updateCartSm validate-required validate-quantity" data-update-url="updateCheckoutCartItems" data-ajax-update=".order-summary, #cart-overview, .notification-messages" data-param-source=".updateCartSm" data-label="quantity" type="text">
                                  × $15.99 = $15.99&nbsp;&nbsp;
                                </fieldset>
                            </small>
                          </td>
                          <td class="cart col-lg-3 col-md-4 col-sm-4 visible-lg">
                              <fieldset class="relative">
                                <input name="quantity_BASIC-T-PURPLE-M" value="1" maxlength="4" class="updateCart validate-required validate-quantity" data-update-url="updateCheckoutCartItems" data-ajax-update=".order-summary, #cart-overview, .notification-messages" data-param-source=".updateCart" data-label="quantity" type="text">
                              </fieldset>
                          </td>
                          <td class="visible-lg"><span class="pull-right">$15.99</span></td>
                        </tr>
                          ...
                          <table class="table">
                            <tbody>
                              <tr class="subtotal">
                                ...
                                <td class="col-md-2"><span class="pull-right">$31.98</span></td>
                              </tr><tr>
                              </tr><tr>
                                ...
                                <td><span class="pull-right">$31.98</span></td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
