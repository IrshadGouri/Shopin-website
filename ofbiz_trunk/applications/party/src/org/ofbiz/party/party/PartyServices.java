...
//                Map<String, Object> partyStatusCtx = UtilMisc.toMap("partyId", partyId, "statusId", statusId, "statusDate", statusDate);
//                dispatcher.runSync("createPartyStatus", partyStatusCtx);
